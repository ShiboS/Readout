...
for Temp in range(StartTemp, EndTemp+Step, Step):
    ...
    for i in range(1,3600):
        ...
        if ((float(LS350.GetTemp("D"))<=Temp/1000.*1.01) and (float(LS350.GetTemp("D"))>=Temp/1000.*0.99)):
            time.sleep(20)
            if ((float(LS350.GetTemp("D"))<=Temp/1000.*1.01) and (float(LS350.GetTemp("D"))>=Temp/1000.*0.99)):
                time.sleep(15)
                if ((float(LS350.GetTemp("D"))<=Temp/1000.*1.01)and (float(LS350.GetTemp("D"))>=Temp/1000.*0.99)):
